...
MM_PRIVILEGED_LATENT_LOSS_WEIGHT="${MM_PRIVILEGED_LATENT_LOSS_WEIGHT:-0.05}"
MM_PRIVILEGED_LATENT_LOSS_START_EPOCH="${MM_PRIVILEGED_LATENT_LOSS_START_EPOCH:-500}"
MM_PRIVILEGED_LATENT_LOSS_END_EPOCH="${MM_PRIVILEGED_LATENT_LOSS_END_EPOCH:-2000}"
...
exec "$REPO_ROOT/scripts/run_with_memory_guard.sh" \
    ...
    --privileged-latent-loss-weight "$MM_PRIVILEGED_LATENT_LOSS_WEIGHT" \
    --privileged-latent-loss-start-epoch "$MM_PRIVILEGED_LATENT_LOSS_START_EPOCH" \
    --privileged-latent-loss-end-epoch "$MM_PRIVILEGED_LATENT_LOSS_END_EPOCH" \
