...
MM_SPLIT="${MM_SPLIT:-all}"
MM_TEACHER_MODE="${MM_TEACHER_MODE:-body_scene}"
...
MM_TEACHER_EXPERIMENT_NAME="${MM_TEACHER_EXPERIMENT_NAME:-egobody_smpl_teacher_${MM_TEACHER_MODE}_40_counterfactual_v1}"
